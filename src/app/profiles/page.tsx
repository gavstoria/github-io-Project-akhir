    ...
    const fetchProfile = async () => {
      try {
        ...
        if (profile) {
          ...
          setUploadedPhotos(profile.photos || [])
        }
      } catch (error) {
              ...
              {!isEditing ? (
                <>
                  ...
                  <div className="w-full space-y-4">
                    ...
                    <div className="mt-6">
                      <p className="text-lg opacity-75 mb-2">My Photos:</p>
                ...
                <div className="w-full space-y-4">
                  ...
                  <div className="mt-4">
                    <p className="text-lg mb-2">Add Photos:</p>
                    <label className="block w-full px-4 py-2 bg-white text-indigo-600 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors text-center">
                      <input
                        type="file"
                        accept="image/*"
                        multiple
